...
public class ConnectDb {
	...
	public static Connection getConn(String driver, String link, String user, String pwd){
		return Conn(driver, link, user, pwd);
	}

	public static Connection getConn_Sqlite(String link){
		return Conn(Sqlite, link, null, null);
	}

	public static Connection getConn_Oracle(String user, String pwd){
		return Conn(Oracle, Oracle_link, user, pwd);
	}

	public static Connection getConn_Oracle(String link, String user, String pwd){
	 ...
	 * @return
	 */
	private static Connection Conn(String driver, String link, String user, String pwd){
		//检查驱动
		try {
